...
public class ActivitySettings extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        Preference pref_vhosts_manage = screen.findPreference("vhosts_manage");
        pref_vhosts_manage.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(ActivitySettings.this, ActivityVirtualHost.class));
                return true;
            }
        });
