...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createTableVirtualHosts(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS virtual_hosts (" +
                ...
                "time INTEGER NOT NULL)");
        db.execSQL("CREATE INDEX IF NOT EXISTS idx_vhosts_domain ON virtual_hosts(domain)");
        db.execSQL("CREATE INDEX IF NOT EXISTS idx_vhosts_enabled ON virtual_hosts(enabled)");
    }
